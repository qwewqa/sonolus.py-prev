...
def process_ast_function(fn, return_parameter: str | None):
    import sonolus.scripting.internal.control_flow as cf
    from sonolus.scripting.internal.control_flow import Execute, ExecuteVoid
    from sonolus.scripting.internal.primitive import Bool, Num
    from sonolus.scripting.internal.void import Void
    from sonolus.scripting.internal.iterator import iter_of
